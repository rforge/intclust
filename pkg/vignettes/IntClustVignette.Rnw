...
BinFeaturesPlot<-function(colors1=c('gray90','blue'),colors2=c('gray90','green'),margins=c(5.5,3.5,0.5,5.5),plottype="new",location=NULL){
...
\begin{figure}[H]
  \begin{minipage}[b]{.5\linewidth}
     \centering
<<FeaturesPlotFP,fig=TRUE,echo=FALSE,width=14,height=14>>=
BinFeaturesPlot(LeadCpds=Comps,OrderLab=MCF7_F,Features=
